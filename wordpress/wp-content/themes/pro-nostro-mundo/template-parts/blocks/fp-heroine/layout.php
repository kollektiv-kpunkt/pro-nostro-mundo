...
<div class="pnm-fp-heroine alignfull mt-5 relative">
    <div class="fp-heroine-inner">
        <div class="fp-heroine-slide-img alignwide !px-6 relative" class="flex">
            <img src="<?= wp_get_attachment_image_url($initial["slide_image"]["ID"], "large") ?>" srcset="<?= wp_get_attachment_image_srcset($initial["slide_image"]["ID"], "large") ?>" alt="<?= $initial["title"] ?>" class="aspect-16/9 object-cover" loading="lazy">
        ...
        <div class="fp-heroine-slide-content !w-fit absolute alignfull bottom-0 pb-5">
            <div class="fp-heroine-slide-content-container bg-pnm-accent max-w-lg p-6 text-white mb-2">
                <hr class="pnm-hr-accent mb-4 shadow-lg"/>
                <h2 class="text-lg sm:text-2xl md:text-3xl xl:text-4xl leading-tight">
                    <?= $initial["title"] ?>
                </h2>
            </div>
