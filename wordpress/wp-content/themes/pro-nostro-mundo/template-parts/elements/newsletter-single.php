<form action="<?= $_ENV["N8N_BASE_URL"] ?>/webhook/<?= $_ENV["N8N_NEWSLETTER_WEBHOOK"] ?>" class="pnm-form pnm-ajax-form pnm-newsletter-form" method="POST">
    ...
    <div class="pnm-form-group relative !w-full">
        <label for="email" class="pnm-form-label sr-only" aria-label="<?= esc_html__("E-Mail Adresse", "pnm") ?>"><?= esc_html__("E-Mail Adresse", "pnm") ?></label>
